...
Example for Skypack
```javascript
import { Uuid } from "https://cdn.skypack.dev/@i-xi-dev/uuid@3.0.10";
```


## Usage

### [`Uuid`](https://doc.deno.land/https://raw.githubusercontent.com/i-xi-dev/uuid.es/3.0.10/mod.ts/~/Uuid) class
