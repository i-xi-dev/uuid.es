...
Deno.test("Uuid.generateRandom()", () => {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      assertStrictEquals(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.test(uuid.toString()), true);
      uuids.push(uuid);
    };
...
Deno.test("Uuid.prototype.format({})", () => {
    const uuid = Uuid.fromString("4525970B49CB4D89998754BA4263AC99");
    assertStrictEquals(uuid.format({}), "4525970b-49cb-4d89-9987-54ba4263ac99");
    assertStrictEquals(uuid.format({upperCase:true}), "4525970B-49CB-4D89-9987-54BA4263AC99");
    assertStrictEquals(uuid.format({upperCase:true,noHyphens:true}), "4525970B49CB4D89998754BA4263AC99");
    assertStrictEquals(uuid.format({upperCase:true,noHyphens:false}), "4525970B-49CB-4D89-9987-54BA4263AC99");
...
Deno.test("Uuid.prototype.toURN()", () => {
    const uuid = Uuid.fromString("00000000-0000-0000-0000-000000000000");
    assertStrictEquals(uuid.toURN().toString(), "urn:uuid:00000000-0000-0000-0000-000000000000");
...
Deno.test("Uuid.prototype.equals(string)", () => {
    const uuid0 = Uuid.nil();
    assertStrictEquals(uuid0.equals("00000000-0000-0000-0000-000000000000"), true);
    assertStrictEquals(uuid0.equals("urn:uuid:00000000-0000-0000-0000-000000000000"), true);
    ...
    const uuid1b = Uuid.fromString("5eb893ba-ec79-4f55-958d-66731227b662");
    const uuid2 = Uuid.fromString("5eb893ba-ec79-4f55-958d-66731227b663");
    assertStrictEquals(uuid0.equals("5eb893ba-ec79-4f55-958d-66731227b662"), false);
    assertStrictEquals(uuid1b.equals("5eb893ba-ec79-4f55-958d-66731227b662"), true);
    assertStrictEquals(uuid2.equals("5eb893ba-ec79-4f55-958d-66731227b662"), false);
